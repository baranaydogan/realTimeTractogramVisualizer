/********************************************************************************
** Form generated from reading UI file 'rttvis_gui_VTK9.ui'
**
...
#ifndef UI_RTTVIS_GUI_VTK9_H
#define UI_RTTVIS_GUI_VTK9_H
...
public:
    ...
    void setupUi(QMainWindow *RTTVIS_GUI)
    {
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 329, 426));
        ...
        gridLayout_9->addItem(verticalSpacer_6, 7, 1, 1, 1);
        ...
        check_uncertainty = new QCheckBox(scrollAreaWidgetContents_4);
        check_uncertainty->setObjectName(QString::fromUtf8("check_uncertainty"));
        check_uncertainty->setEnabled(false);

        gridLayout_9->addWidget(check_uncertainty, 6, 0, 1, 1);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 329, 426));
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 242, 385));
    ...
    void retranslateUi(QMainWindow *RTTVIS_GUI)
    {
        ...
        check_uncertainty->setText(QCoreApplication::translate("RTTVIS_GUI", "Show uncertainty", nullptr));
